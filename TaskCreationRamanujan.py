...
def getConnection():
    ...
    url = "jdbc:sqlserver://ramanujan:1433;database=intalo_ramanujan1"
    conn = DriverManager.getConnection(url,"sa", "Intali0")
    return conn 
...
headers6= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://ramanujan:8080/login.htm'), ]

headers7= \
  [ NVPair('Accept', 'application/json, text/javascript, */*; q=0.01'),
    NVPair('Referer', 'http://ramanujan:8080/index.htm;jsessionid=0D7D89DBE69BEC9D45709F9FA00D92A9'), ]
...
headers12= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://ramanujan:8080/gi/apppath/AjaxTesting/form.gi/IntalioInternal/ServerLaunch.html?id=f1e71b24-a117-4cef-bcc8-aa2899e6e240&type=PIPATask&url=%2Fgi%2Fapppath%2FAjaxTesting%2Fform.gi%2FIntalioInternal%2FServerLaunch.html&token=&user=intalio%5Cadmin&claimTaskOnOpen=false'), ]
...
headers20= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://ramanujan:8080/xFormsManager/init?id=6c8f64ba-1c38-4dec-82e4-33a632752d4c&type=PIPATask&url=oxf%3A%2F%2FWorkflowTabPane%2Fdetails.xform&token=&user=intalio%5Cadmin&claimTaskOnOpen=false'),
    NVPair('Cache-Control', 'no-cache'), ]
...
headers22= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://ramanujan:8080/ui-fw/tasks.htm'), ]
...
headers36= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://ramanujan:8080/gi/apppath/RepeatEvery_PXEI_897/Forms/start.gi/IntalioInternal/ServerLaunch.html?id=d8ae9f02-c9e9-4017-a33a-2c129d400e29&type=PIPATask&url=%2Fgi%2Fapppath%2FRepeatEvery_PXEI_897%2FForms%2Fstart.gi%2FIntalioInternal%2FServerLaunch.html&token=&user=intalio%5Cadmin&claimTaskOnOpen=false'), ]
...
headers67= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://ramanujan:8080/gi/apppath/ScheduleActionPA/form.gi/IntalioInternal/ServerLaunch.html?id=11d1def534ea1be0:-22d659cb:13b835e25e8:-12ac127.0.0.169&type=PATask&url=http%3A%2F%2Framanujan%3A8080%2Fgi%2Fapppath%2FScheduleActionPA%2Fform.gi%2FIntalioInternal%2FServerLaunch.html&token=&user=intalio%5Cadmin&claimTaskOnOpen=false'), ]
...
class TestRunner:
  ...
  def page14(self):
    ...
    request1402.GET('/images/sort_both.png', None,
      ( NVPair('Accept', 'image/png,image/*;q=0.8,*/*;q=0.5'),
        NVPair('Referer', 'http://ramanujan:8080/style/plugin/jquery.dataTables.css'),
        NVPair('If-Modified-Since', 'Sat, 08 Dec 2012 14:39:00 GMT'),
  ...
  def page52(self):
    ...
    paTaskId=""
    size=0
    query = 'select distinct task.taskid from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%AjaxTesting%\''
    i=1
    while (size==0):
            if(i>10):
                break
...
initRequest></SOAP-ENV:Body>
  ...
  def page58(self):
    ...
    self.token_url = \
      'http://ramanujan:8080/gi/apppath/ScheduleActionPA/form.gi/IntalioInternal/ServerLaunch.html'
  ...
  def page64(self):
    ...
    query = 'select distinct task.taskid, task.creation_date   from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%ScheduleActionPA%\''
    i=1
    while (size==0):
            if(i>10):
                break
...
ENV:Body>
  ...
  def page77(self):
    ...
    # 28 different values for token_url found in response, using the first one.
    self.token_url = \
      httpUtilities.valueFromBodyURI('url') # 'http://ramanujan:8080/gi/apppath/ScheduleAct...'
    # 3 different values for token_token found in response; the first matched
    # the last known value of token_token - don't update the variable.
...
<SOAP-ENV:Body><jsx1:getTaskRequest xmlns:jsx1=\"http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/\"><jsx1:taskId>'''+pipaTaskId+'''</jsx1:taskId><jsx1:participantToken></jsx1:participantToken></jsx1:getTaskRequest></SOAP-ENV:Body>
  ...
  def page99(self):
    ...
    query = 'select distinct task.taskid from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%SubstarctDates%\''
    i=1
    while (size==0):
            if(i>10):
                break
...
html</jsx1:formUrl></jsx1:initRequest></SOAP-ENV:Body>
  ...
  def page111(self):
    ...
    query = 'select distinct task.taskid from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%ScheduleActions_PXEI_874%\''  
    i=1
    while (size==0):
            if(i>10):
                break
...
PXEI_874/ActionForms.gi/IntalioInternal/ServerLaunch.html</jsx1:formUrl></jsx1:initRequest></SOAP-ENV:Body>
  ...
  def page123(self):
    ...
    query = 'select distinct task.taskid from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%RepeatEvery_PXEI_897%\''  
    i=1
    while (size==0):
            if(i>10):
                break
...
ENV:Body>
  ...
  def page135(self):
    ...
    query = 'select distinct task.taskid from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%Ajax_Radio%\''  
    i=1
    while (size==0):
            if(i>10):
                break
...
<SOAP-ENV:Body><jsx1:getTaskRequest xmlns:jsx1=\"http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/\"><jsx1:taskId>'''+paTaskId+'''</jsx1:taskId><jsx1:participantToken></jsx1:participantToken></jsx1:getTaskRequest></SOAP-ENV:Body>
  ...
  def page208(self):
    ...
    query = 'select distinct task.taskid, task.creation_date from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%RepeatEvery_PXEI_897%\''
    i=1
    while (size==0):
            if(i>10):
                break
...
<SOAP-ENV:Body><jsx1:getTaskRequest xmlns:jsx1=\"http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/\"><jsx1:taskId>'''+paTaskId+'''</jsx1:taskId><jsx1:participantToken></jsx1:participantToken></jsx1:getTaskRequest></SOAP-ENV:Body>
  ...
  def page225(self):
    ...
    query = 'select distinct task.taskid, task.creation_date   from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%SubstarctDates%\''
    i=1
    while (size==0):
            if(i>10):
                break
...
ENV:Body>
  ...
  def page238(self):
    ...
    query = 'select distinct task.taskid from tempo_task task INNER JOIN tempo_pa pa on task.id=pa.id where pa.state = \'0\' and form_url like \'%ScheduleActionPA%\''
    i=1
    while (size==0):
            if(i>10):
                break
